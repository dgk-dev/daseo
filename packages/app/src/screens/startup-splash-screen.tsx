...
import { DASEO_LOGO_PATH, PaseoLogo } from "@/components/icons/paseo-logo";
...
function WebLogoShimmer({ color }: { color: string }) {
  ...
  const shimmerStyle = useMemo(
    () => ({
      width: LOGO_SIZE,
      height: LOGO_SIZE,
      WebkitMaskImage: `url("data:image/svg+xml,${encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path fill='black' fill-rule='evenodd' d='${DASEO_LOGO_PATH}'/></svg>`)}")`,
